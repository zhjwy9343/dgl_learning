...
def main(args):
    ...
    # create the dataset
    train_dataset = PPIDataset(mode='train') # contain 20 graphs 
    ...
    # define the model
    model = GAT(g, # TODO g is from train dataset, how do the model eval the eval dataset? 
                args.num_layers,
                num_feats,
                args.num_hidden,
                n_classes,
    ...
    for epoch in range(args.epochs):
        ...
        for batch, subgraph in enumerate(train_dataloader):
            ...
            model.g = subgraph # TODO seems can change the graph of model each subgraph
            for layer in model.gat_layers:
                layer.g = subgraph
